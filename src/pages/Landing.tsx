  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="animate-slideUp text-center lg:text-left">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl leading-[1.1] text-foreground mb-5 sm:mb-7 font-display">
                ...
                <span
                  style={{
                    background: 'linear-gradient(135deg, hsl(292 91% 58%) 0%, hsl(258 90% 66%) 100%)',
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 mb-5 justify-center lg:justify-start">
                <button
                  ...
                  className="w-full sm:w-auto px-7 sm:px-8 py-3.5 sm:py-4 rounded-xl text-white font-medium magenta-gradient text-base sm:text-lg flex items-center justify-center gap-3 hover:opacity-90 transition-opacity group"
                >
                  Try it free
        ...
        <button 
          onClick={() => navigate('/dashboard')}
          className="w-full sm:w-auto px-8 py-4 rounded-xl text-white font-medium magenta-gradient text-lg hover:opacity-90 transition-opacity group inline-flex items-center gap-3"
        >
          Start pitching
          <ArrowRight className="w-5 h-5 group-hover:translate-x-0.5 transition-transform" />
        </button>
