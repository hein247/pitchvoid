  ...
  return <section className="min-h-screen flex flex-col items-center justify-center px-6 py-20 relative overflow-hidden">
      ...
      ease: "easeOut"
        ...
        <div className="relative aspect-[16/9] rounded-sm overflow-hidden shadow-2xl">
          <img src={ringHero} alt="Dôme Figure Ring - Hero Campaign" className="w-full h-full object-cover" />
      ...
      duration: 0.6
        ...
        <a href="#challenge" className="flex flex-col items-center gap-2 text-muted-foreground hover:text-foreground transition-colors">
