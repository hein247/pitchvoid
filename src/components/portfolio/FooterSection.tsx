...
const FooterSection = () => {
  ...
  return (
    <footer className="py-32 px-6 bg-foreground text-background" ref={ref}>
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-lg text-background/70 max-w-xl mx-auto leading-relaxed">
            This presentation demonstrates how AI tools can accelerate creative workflows 
            while maintaining the quality and brand consistency that defines Mejuri.
          </p>
