...
const channels = [
  { name: "Email", description: "Hero banners, product highlights", icon: "📧" },
  { name: "Social", description: "Instagram, Stories, Pinterest", icon: "📱" },
  { name: "Web", description: "Homepage banners, product pages", icon: "🖥️" },
  { name: "In-Store", description: "Signage, display cards", icon: "🏬" },
];
...
const ChallengeSection = () => {
  ...
  return (
    <section id="challenge" className="py-32 px-6 bg-secondary/30" ref={ref}>
