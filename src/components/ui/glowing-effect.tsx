  ...
  ({
    ...
    return (
      <>
              ...
              "--gradient":
                variant === "white"
                  ...
                  : `repeating-conic-gradient(
                      from calc(var(--start) * 1deg),
                      hsl(var(--primary)) 0%,
                      hsl(var(--electric-magenta)) 5%,
                      transparent 5%,
                      transparent 40%,
                      hsl(var(--deep-violet)) 50%
                    )`,
            } as React.CSSProperties
          }
          className={cn(
        ...
        >
          <div
            className="glow absolute inset-[calc(-1*var(--glowingeffect-border-width))] rounded-[inherit] border-[length:var(--glowingeffect-border-width)] border-solid border-transparent"
            style={{
