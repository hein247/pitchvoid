...
const SlideEditor = ({ slide, slideIndex, onUpdate, onGenerateImage, isGeneratingImage }: SlideEditorProps) => {
  ...
  return (
    <div className="space-y-6 font-sans bg-muted/50 dark:bg-white/[0.03] backdrop-blur-[10px] border border-border p-6 rounded-lg">
      {/* Slide Header */}
      ...
      <div className="space-y-2">
        ...
        >
          <SelectTrigger className="bg-background dark:bg-white/[0.03] border-border focus:border-primary focus:ring-primary/30 z-50">
            <SelectValue placeholder="Select layout" />
          </SelectTrigger>
          <SelectContent className="bg-popover dark:bg-[hsl(270_60%_8%)] border-border z-50">
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          className="bg-background dark:bg-white/[0.03] border-border focus:border-primary focus:ring-primary/30 focus:shadow-[0_0_15px_hsl(var(--primary)/0.2)] text-lg font-display transition-all duration-300"
          maxLength={100}
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          className="bg-background dark:bg-white/[0.03] border-border focus:border-primary focus:ring-primary/30 focus:shadow-[0_0_15px_hsl(var(--primary)/0.2)] min-h-[100px] resize-none font-sans transition-all duration-300"
          maxLength={500}
        />
      </div>
            ...
            >
              ...
              <div className="flex-1 flex items-center gap-2">
                ...
                <Input
                  ...
                  className="bg-background dark:bg-white/[0.03] border-border focus:border-primary focus:ring-primary/30 focus:shadow-[0_0_10px_hsl(var(--primary)/0.15)] font-sans transition-all duration-300"
                  maxLength={200}
                />
              </div>
              <Button
