    ...
    <section ref={scope} className="w-full py-20 sm:py-32 px-4 sm:px-8">
      ...
      <div
        ...
        style={{
          ...
          minHeight: isMobile ? '640px' : 'clamp(680px, 75vw, 760px)',
        }}
      >
        <div className="relative w-full h-full flex items-center justify-center" style={{ minHeight: isMobile ? '640px' : 'clamp(680px, 75vw, 760px)' }}>
          ...
          <div className="absolute bottom-10 sm:bottom-12 left-0 right-0 flex justify-center z-50 pointer-events-none">
            <div className="cta-area pointer-events-auto" style={{ opacity: 0, scale: 0.9 }}>
              <button
                onClick={enterVoid}
                className="px-8 py-4 rounded-full text-primary-foreground font-semibold brand-gradient text-base sm:text-lg hover:opacity-90 hover:scale-105 transition-all cursor-pointer shadow-[0_0_30px_rgba(168,85,247,0.5)] border border-white/20 group inline-flex items-center gap-3"
              >
                Enter the void
